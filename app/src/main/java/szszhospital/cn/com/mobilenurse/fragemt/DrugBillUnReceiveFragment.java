 ...
 * 药品接受界面(需要扫描二维码)
 */
public class DrugBillUnReceiveFragment extends BaseScanFragment<FragmentDrugReceiverBinding, DrugBillUnReceivePresenterImpl> implements DrugBillUnReceiveContract.View {
    @Override
